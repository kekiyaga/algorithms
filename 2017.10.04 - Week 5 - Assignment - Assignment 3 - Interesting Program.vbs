' I find this script interesting because exporting AD user info to CSVs
' creates a lot of possibilities to interact with the info in other programs
' based on the specified filters.  This can be done automatically rather than manually with various programming languages
