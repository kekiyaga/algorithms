...
for (var num in jsonObj) {
	...
	console.log(movie + " had an average score of " + scoreObj + " from " 
	+ sumObj + " reviewers, scoring " + jsonObj[num]["score_div"] 
	+ " when weighing the average score and number of reviews the film received.");
};
